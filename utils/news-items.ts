...
export const newsData: Content[] = [
  ...
  },
  {
    id: 7,
    type: 'news',
    title: 'Live at KOKO - Part 1',
    author: {
      name: 'Andy',
    },
    summary: 'Live at KOKO / Photos - Part 1',
    story: 'What a fantastic night with the Goldfat crew,',
    date: new Date('2022-04-22').toString(),
    image: '/images/live/GoldfatXoyo-9.jpg',
    link: 'https://www.koko.co.uk/',
  },
  {
    id: 8,
    type: 'news',
    title: 'Live at KOKO - Part 2',
    author: {
      name: 'Andy',
    },
    summary: 'Live at KOKO / Photos - Part 2',
    story: 'What a fantastic night with the Goldfat crew,',
    date: new Date('2022-04-22').toString(),
    image: '/images/live/GoldfatXoyo-10.jpg',
    link: 'https://koko.co.uk/whats-on',
  },
  {
    id: 9,
    type: 'news',
    title: 'Live at KOKO - Part 3',
    author: {
      name: 'Andy',
    },
    summary: 'Live at KOKO / Photos - Part 3',
    story: 'What a fantastic night with the Goldfat crew,',
    date: new Date('2022-04-22').toString(),
